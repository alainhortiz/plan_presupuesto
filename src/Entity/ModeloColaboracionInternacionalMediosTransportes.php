...
use App\Repository\ModeloColaboracionInternacionalMediosTransportesRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ModeloColaboracionInternacionalMediosTransportesRepository::class)]
class ModeloColaboracionInternacionalMediosTransportes
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'modeloColaboracionInternacionalMediosTransportes')]
    private ?AnteProyectoPlanPresupuesto $anteProyectoPlanPresupuesto = null;

    #[ORM\ManyToOne(inversedBy: 'entidadModeloColaboracionInternacionalMediosTransportes')]
    private ?Entidad $entidad = null;

    #[ORM\ManyToOne(inversedBy: 'modeloColaboracionInternacionalMediosTransportes')]
    private ?Estado $estado = null;

    #[ORM\ManyToOne(inversedBy: 'registraModeloColaboracionInternacionalMediosTransportes')]
    private ?User $userRegistra = null;

    #[ORM\ManyToOne(inversedBy: 'validaModeloColaboracionInternacionalMediosTransportes')]
