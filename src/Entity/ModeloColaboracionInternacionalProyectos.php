...
use App\Repository\ModeloColaboracionInternacionalProyectosRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ModeloColaboracionInternacionalProyectosRepository::class)]
class ModeloColaboracionInternacionalProyectos
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'modeloColaboracionInternacionalProyectos')]
    private ?AnteProyectoPlanPresupuesto $anteProyectoPlanPresupuesto = null;

    #[ORM\ManyToOne(inversedBy: 'entidadModeloColaboracionInternacionalProyectos')]
    private ?Entidad $entidad = null;

    #[ORM\ManyToOne(inversedBy: 'modeloColaboracionInternacionalProyectos')]
    private ?Estado $estado = null;

    #[ORM\ManyToOne(inversedBy: 'registraModeloColaboracionInternacionalProyectos')]
    private ?User $userRegistra = null;

    #[ORM\ManyToOne(inversedBy: 'validaModeloColaboracionInternacionalProyectos')]
