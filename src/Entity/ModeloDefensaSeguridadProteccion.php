...
use App\Repository\ModeloDefensaSeguridadProteccionRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ModeloDefensaSeguridadProteccionRepository::class)]
class ModeloDefensaSeguridadProteccion
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'modeloDefensaSeguridadProteccion')]
    private ?AnteProyectoPlanPresupuesto $anteProyectoPlanPresupuesto = null;

    #[ORM\ManyToOne(inversedBy: 'entidadModeloDefensaSeguridadProteccion')]
    private ?Entidad $entidad = null;

    #[ORM\ManyToOne(inversedBy: 'modeloDefensaSeguridadProteccions')]
    private ?Estado $estado = null;

    #[ORM\ManyToOne(inversedBy: 'registraModeloDefensaSeguridadProteccion')]
    private ?User $userRegistra = null;

    #[ORM\ManyToOne(inversedBy: 'validaModeloDefensaSeguridadProteccion')]
