...
use App\Repository\ModeloDinamicaDemograficaRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ModeloDinamicaDemograficaRepository::class)]
class ModeloDinamicaDemografica
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'modeloDinamicaDemografica')]
    private ?AnteProyectoPlanPresupuesto $anteProyectoPlanPresupuesto = null;

    #[ORM\ManyToOne(inversedBy: 'entidadModeloDinamicaDemografica')]
    private ?Entidad $entidad = null;

    #[ORM\ManyToOne(inversedBy: 'modeloDinamicaDemograficas')]
    private ?Estado $estado = null;

    #[ORM\ManyToOne(inversedBy: 'registraModeloDinamicaDemografica')]
    private ?User $userRegistra = null;

    #[ORM\ManyToOne(inversedBy: 'validaModeloDinamicaDemografica')]
