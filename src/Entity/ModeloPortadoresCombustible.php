...
use App\Repository\ModeloPortadoresCombustibleRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ModeloPortadoresCombustibleRepository::class)]
class ModeloPortadoresCombustible
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'modeloPortadoresCombustible')]
    private ?AnteProyectoPlanPresupuesto $anteProyectoPlanPresupuesto = null;

    #[ORM\ManyToOne(inversedBy: 'entidadModeloPortadoresCombustible')]
    private ?Entidad $entidad = null;

    #[ORM\ManyToOne(inversedBy: 'modeloPortadoresCombustibles')]
    private ?Estado $estado = null;

    #[ORM\ManyToOne(inversedBy: 'registraModeloPortadoresCombustible')]
    private ?User $userRegistra = null;

    #[ORM\ManyToOne(inversedBy: 'validaModeloPortadoresCombustible')]
