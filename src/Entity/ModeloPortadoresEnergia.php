...
use App\Repository\ModeloPortadoresEnergiaRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ModeloPortadoresEnergiaRepository::class)]
class ModeloPortadoresEnergia
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'modeloPortadoresEnergia')]
    private ?AnteProyectoPlanPresupuesto $anteProyectoPlanPresupuesto = null;

    #[ORM\ManyToOne(inversedBy: 'entidadModeloPortadoresEnergia')]
    private ?Entidad $entidad = null;

    #[ORM\ManyToOne(inversedBy: 'modeloPortadoresEnergias')]
    private ?Estado $estado = null;

    #[ORM\ManyToOne(inversedBy: 'registraModeloPortadoresEnergia')]
    private ?User $userRegistra = null;

    #[ORM\ManyToOne(inversedBy: 'validaModeloPortadoresEnergia')]
