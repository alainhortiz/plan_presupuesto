...
use App\Repository\ModeloPortadoresServiciosRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ModeloPortadoresServiciosRepository::class)]
class ModeloPortadoresServicios
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'entidadModeloPortadoresServicios')]
    private ?Entidad $entidad = null;

    #[ORM\ManyToOne(inversedBy: 'modeloPortadoresServicios')]
    private ?Estado $estado = null;

    #[ORM\ManyToOne(inversedBy: 'registraModeloPortadoresServicios')]
    private ?User $userRegistra = null;

    #[ORM\ManyToOne(inversedBy: 'validaModeloPortadoresServicios')]
